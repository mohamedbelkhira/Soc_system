...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-left md:tex-center md:text-lg font-medium leading-none tracking-tight",
      className
    )}
    {...props}
  />
